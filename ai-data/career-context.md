...
**Institution:** Budge Budge Institute of Technology (MAKAUT, West Bengal)  
...
- **Google Cloud Associate Cloud Engineer** - [Credly Badge](https://www.credly.com/badges/7af9ebab-6364-42a3-b1b8-200fb56b101a/public_url)
- **Preparing for:** Google Cloud Professional Cloud Architect
- **Certificate of Appreciation** from Purplle for contributions during the Aug '23 "I Heart Beauty Sale"
...
### 1. Infra Provision System Automation
**Status:** Production  
**Category:** DevOps  
**Technologies:** Terraform, Python, Bash, GitLab CI, Jenkins, GCP

**Description:**
Automated infrastructure provisioning, backups, and role management to reduce manual effort, improve reliability, and accelerate cloud operations at purplle.com.
...
**Description:**
Automated infrastructure monitoring and alerting to improve incident response, reduce downtime, and proactively detect issues at purplle.com.
...
**Description:**
Real-time chat application created with NodeJS, Express, and Socket-IO on the backend and React on the frontend. Users can join groups and instant message one another using Socket.IO with user authentication using JSON Web Tokens (JWT) saved in MongoDB Database.

**Source Code:** https://github.com/thisiskushal31/SocialSplit
...
Comprehensive documentation and learning resources across multiple repositories:

1. **Data Structures & Algorithms** - DSA notes and solved problems
2. **DevOps Handbook** - CI/CD, IaC, cloud-native, observability, security
3. **Containerization Deep Dive** - Docker, Kubernetes fundamentals
4. **Databases Deep Dive** - Relational, NoSQL, analytical, managed services
5. **Networks Deep Dive** - Networking from physical layers to cloud-native
6. **System Design Concepts** - Patterns, components, and trade-offs
7. **Commands and Cheatsheets** - Essential commands and tool references
...
- **LinkSaver Chrome Extension** - Save active tabs for later reading
- **Modern React Portfolio Starter** - Customizable React portfolio template
- **Configurable React Bio Link Starter** - Linktree-style bio links template
- **Configurable React Blog Starter** - Modern blog template with Markdown
...
### Target Companies
- Companies using cloud-native technologies (GCP, AWS)
- Organizations with Kubernetes-based infrastructure
- Companies focused on platform engineering
- Organizations valuing automation and DevOps culture

### Application Strategy
- Highlight production metrics and quantifiable impact
- Emphasize automation and cost optimization achievements
- Showcase security-first approach
- Demonstrate technical writing and knowledge sharing
