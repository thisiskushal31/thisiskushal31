...
**For LinkedIn (Entry):**
- **Entry 1: [Job Title]** | **Period:** [Start] - [End] | **Location:** [City, State, Country]
- Description bullets: [Achievement 1], [Achievement 2], [Achievement 3]

**For Resume (Role):**
- **Role 1: [Job Title]** | **Period:** [Start] - [End] | **Type:** Full-time
- **Role Description:** [Brief description]
- **Key Achievements:** [Bullet 1], [Bullet 2], [Bullet 3]
- **Technologies Used:** [Tech 1], [Tech 2], [Tech 3]

**For Portfolio (portfolio.ts):**
- **role**, **duration**, **type**, **description**, **achievements** (array), **technologies** (array)
