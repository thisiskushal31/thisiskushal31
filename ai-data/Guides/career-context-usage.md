...
Generate a short, crisp cold email (under 150 words) that:
1. Shows genuine excitement about the company/role
2. Highlights 3-4 specific value propositions from my experience
3. Uses quantifiable achievements (50% faster deployments, 76% MTTR reduction, etc.)
4. Matches their tech stack and needs
...
1. Technical keywords from JD that match my skills
2. Industry-specific terms
3. Action verbs and power words
4. Certifications and credentials
5. Tools and technologies

Create a keyword-optimized version of my experience section.
```

---

### 4. Tailor CV/Resume for Specific JD
...
Please:
1. Reorder and emphasize relevant experience/projects
2. Highlight matching technologies and skills
3. Quantify achievements where possible
4. Align language with job requirements
5. Include relevant keywords naturally
6. Create a tailored summary/objective

Generate a customized resume section for this role.
```
...
- Recent News: [NEWS/INITIATIVES]
- Challenges: [KNOWN_CHALLENGES]
- Values: [COMPANY_VALUES]

Customize my application by:
1. Matching my projects to their needs
2. Highlighting relevant achievements
3. Showing understanding of their challenges
4. Demonstrating cultural fit
5. Creating company-specific value propositions
```
...
Prepare me by:
1. Identifying key talking points from my experience
2. Creating STAR method stories for achievements
3. Matching my skills to their requirements
4. Preparing questions about their challenges
5. Highlighting relevant projects to discuss
6. Technical questions I should prepare for
```
...
Help me:
1. Identify my unique value propositions
2. Quantify my impact (cost savings, efficiency gains)
3. Research market rates for my profile
4. Prepare negotiation talking points
5. Create a counter-offer strategy
```
...
Identify:
1. Skills I have that match requirements
2. Skills I'm missing
3. Skills I can learn quickly
4. Learning resources and paths
5. Timeline to acquire missing skills
6. How to position existing skills as transferable
```
...
Create a personalized connection request that:
1. Shows genuine interest in their work
2. Mentions a specific commonality
3. Briefly highlights relevant experience
4. Includes a soft ask (optional)
...
- **Iterate:** Generate multiple versions and refine the best one

---

## 📋 Checklist Before Using

- [ ] Career context is up to date
- [ ] Job description is ready
- [ ] Company information is researched
- [ ] Specific requirements are clear
- [ ] Target audience is identified

---

**Remember:** The career context is your foundation. Always include it for accurate, personalized results!
